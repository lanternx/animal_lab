...
def add_mouse():
    ...
    try:
        ...
        mouse.from_cage = data.get('from_cage')
...
def get_all_cages():
    ...
    for cage in cages:
        ...
        cage_data.append({
            ...
            'cage_card_number': cage.cage_card_number
        })
...
def add_cage():
    ...
    try:
        ...
        cage = Cage(
            ...
            cage_card_number=data.get('cage_card_number')
        )
        db.session.add(cage)
        db.session.commit()
...
def update_cage(cage_id):
    ...
    try:
        ...
        if 'cage_card_number' in data:
            cage.cage_card_number = data.get('cage_card_number')
        db.session.commit()
        return jsonify({
            'id': cage.id,
            'cage_id': cage.cage_id,
